...
export const promos: Promo[] = [
  ...
  /* ── Decks ───────────────────────────────────────────────────────────── */
  {
    ...
    services: ['decks'],
    eyebrow: 'Deck offer',
    headline: 'Discounted Lighting Package with a Deck Replacement',
    detail:
      'Combine a low-voltage lighting package with your deck replacement and it comes at a discount — recessed riser lights and post-cap lights, wired and transformer-set. It is the upgrade every homeowner adds after the fact and wishes they had done during the build, and doing it while the framing is open is the cheapest it will ever be.',
    terms:
      'Discount applies when the lighting package is purchased with a full deck replacement and installed on the same job. Discount is off the standard lighting package price; final pricing depends on layout and the number of risers and post caps. Not valid on repairs or as a standalone lighting installation.',
    cta: 'Design my deck',
  ...
  },
  {
    ...
    headline: 'Full Professional Drawings with Every Deck Quote',
    detail:
      'Every deck we quote is drawn up properly first — framing plan, dimensions, railing and stair layout — so you are approving a plan rather than a paragraph. We bring full-size TimberTech and Trex boards to hold against your siding in your own daylight, because composite colour reads nothing like it does on a screen.',
    terms: 'Drawings are provided with every deck proposal within our standard service area. Homeowner must be present for the on-site consultation.',
    cta: 'Book my deck consult',
  ...
  },
  {
    ...
    eyebrow: 'Best value',
    headline: 'Discounted Seamless Gutters with a Full Roof Replacement',
    detail:
      'Replace your roof with us and your new seamless 5" gutters and downspouts come at a discount. The gutters have to come off for the roof anyway — combining the two means one mobilization, one crew visit, and a materially better price than having them done on their own later.',
    terms:
      'Discount applies when seamless gutters are installed together with a complete roof replacement on the same job. Discount is off our standard gutter pricing; 6" upsizing, guards and fascia repair are quoted separately. Final pricing depends on linear footage and downspout count.',
    cta: 'Get my instant roof price',
    ctaHref: '/instant-roof-quote',
    active: true,
    order: 2,
