...
(function () {
  ...
  if (mcta) {
    var showAfter = function () {
      mcta.classList.toggle('is-visible', window.scrollY > 420);
    };
    showAfter();
  ...
  /* ---------- Accessible form validation ----------
     Guidance applied: inline error per field linked with aria-describedby,
     a focusable error summary at the top of the form that links to each
     invalid field, validation on blur rather than submit-only. */
  var forms = document.querySelectorAll('form[data-ff-form]');

  Array.prototype.forEach.call(forms, function (form, fi) {
    // Give every field error an id and connect it to its control.
    ...
    // Error summary, inserted at the top of the form.
  ...
  /* ---------- Multi-step forms ---------- */
  Array.prototype.forEach.call(document.querySelectorAll('[data-multistep]'), function (form) {
  ...
  Array.prototype.forEach.call(forms, function (form) {
    form.addEventListener('submit', function (e) {
      ...
      var finish = function () {
        ...
        if (success) {
          Array.prototype.forEach.call(form.querySelectorAll('.fstep, .form-body, .steps-bar, .form-head, .form-errors'), function (el) {
