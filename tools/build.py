...
SITE = "https://forwardframework.com"
...
<section class="section" id="faq">
  <div class="wrap split">
    <div>
      ...
      <p class="lede">Anything missing? Email <a class="accent" href="mailto:hello@forwardframework.com">hello@forwardframework.com</a> and a strategist replies — not a chatbot.</p>
...
<section class="hero" style="padding-block:clamp(2.5rem,5vw,4rem) clamp(3rem,6vw,5rem)">
  <div class="wrap hero-grid">
    <div>
      ...
      <p class="lede">Prefer to talk first? Call <a class="accent" href="tel:+15550123456">(555) 012-3456</a> or email <a class="accent" href="mailto:hello@forwardframework.com">hello@forwardframework.com</a>. A senior strategist answers, not a scheduler.</p>

      <div class="grid grid-2 mt-7">
        <div class="card"><h3 class="h4">New business</h3><p><a href="mailto:hello@forwardframework.com">hello@forwardframework.com</a><br><a href="tel:+15550123456">(555) 012-3456</a></p></div>
        <div class="card"><h3 class="h4">Existing clients</h3><p><a href="mailto:support@forwardframework.com">support@forwardframework.com</a><br>Same-day response, business hours.</p></div>
...
<section class="section">
  <div class="wrap prose">
    ...
    <h2>Your rights</h2>
    <p>You can request access to, correction of, or deletion of the personal information we hold about you, and you can opt out of marketing communication at any time. Residents of states with applicable privacy laws, including California, have additional rights over the sale or sharing of personal information — we do not sell or share it. Email <a href="mailto:privacy@forwardframework.com">privacy@forwardframework.com</a> and we will respond within 30 days.</p>
    <h2>Cookies</h2>
    ...
    <h2>Contact</h2>
    <p>Questions about this policy: <a href="mailto:privacy@forwardframework.com">privacy@forwardframework.com</a> or (555) 012-3456.</p>
  </div>
</section>"""
...
<section class="section">
  <div class="wrap prose">
    ...
    <h2>Contact</h2>
    <p>Questions about these terms: <a href="mailto:hello@forwardframework.com">hello@forwardframework.com</a>.</p>
  </div>
</section>"""
