...
`buckle-and-bloom/` is a landing page for Buckle &amp; Bloom Car Seat Cleaning, built with these
skills. Static HTML/CSS/JS, no build step — see
[buckle-and-bloom/README.md](buckle-and-bloom/README.md) for the go-live checklist.
