...
These notes predate the website and describe the vendored Claude Code design
skills and the 21st.dev MCP server that live alongside it. They are unrelated
to building or deploying the site.
